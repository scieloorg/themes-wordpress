...
<div class="slideshow">
  ...
  <?php if ($upw_query->have_posts()) : ?>
      ...
      <?php while ($upw_query->have_posts()) : $upw_query->the_post(); ?>
        ...
        <article <?php post_class($current_post); $thumb_id = get_post_thumbnail_id(); $thumb_url = wp_get_attachment_image_src($thumb_id,'thumbnail-size', true);?> style="background: url(<?php echo $thumb_url[0]; ?>);">
          <div class="gradient">
            <div class="post-info">
              <header>
