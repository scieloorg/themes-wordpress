...
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<?php if ( is_user_logged_in() ) { ?>
			<div id="user-info">
				<?php
				    ...
				    get_currentuserinfo();
				    echo '<div class="userName"><a title="profile" href="' . get_edit_user_link() . '">' . $current_user->user_firstname . ' ' . $current_user->user_lastname;
				    echo '</a></div>';
				    echo ' | ';
				    echo wp_loginout();
					echo '<div class="userAvatar">';
					echo '<div class="mask"><a title="profile" href="' . get_edit_user_link() . '"></a></div>';
		...
		<?php } else { ?>
			<div id="login"><?php wp_login_form( $args ); ?></div>
		<?php } ?>
